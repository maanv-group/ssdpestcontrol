	...
	<script type="application/ld+json">
		{
			...
			"itemListElement": [{
				...
				"position": 1,
				"name": "Home Page",
				"item": "https://ssdpestcontrol.com/"
			}, {
				"@type": "ListItem",
				"position": 2,
				"name": "About us",
				"item": "https://ssdpestcontrol.com/about-us"
			}]
		}
	</script>
</head>
...
<body>
	...
	<div class="page-wrapper">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="image-wrapper wow fadeInDown" data-wow-duration="1500ms">
							...
							<div class="image">
								<img loading="lazy" src="assets/images/resource/ssdaboutus.jpeg" alt="">
							</div>
		...
		<section class="whychoose-us-section-two">
			<div class="sec-bg">
				<div class="left-side">
					<svg xmlns="http://www.w3.org/2000/svg" width="960" height="788">
						<path fill-rule="evenodd" fill="#111B31" d="M0-.001h960V788l-840-70c-27.339-2.48-46.419-22.524-50-50.001L0-.001z" />
					</svg>
				</div>
				<div class="right-side" style="background-image: url(assets/images/background/bg-2.jpg);"></div>
			</div>
			<span class="shape-one"><img loading="lazy" src="assets/images/shape/shape-4.png" alt=""></span>
			<span class="shape-two"><img loading="lazy" src="assets/images/shape/shape-5.png" alt=""></span>
			<div class="auto-container">
				<div class="row">
					<div class="col-lg-12">
