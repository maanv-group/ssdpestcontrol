...
<link media="screen and (min-width:200px)" href="<?= base_url()?>assets/css/style.min.css" rel="stylesheet">
<!-- Responsive File -->
<link media="screen and (min-width:300px)" href="<?= base_url()?>assets/css/responsive.css" rel="stylesheet">
<!-- Color File -->
<link media="screen and (min-width:200px)" href="<?= base_url()?>assets/css/color.css" rel="stylesheet">

<link media="screen and (min-width:200px)" href="https://fonts.googleapis.com/css2?family=Abril+Fatface&amp;family=Poppins:wght@400;500;600;700;800&amp;display=swap" rel="stylesheet">

<link media="screen and (min-width:200px)" rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
